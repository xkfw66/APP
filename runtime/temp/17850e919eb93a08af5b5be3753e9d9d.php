<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"D:\phpStudy\WWW\APP\public/../application/admin\view\outlook\outlook.html";i:1499055012;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    <div class="text-c">
	 ...
	 <span class="select-box inline">
        ...
        <input type="text" name="outlook" id="outlook" placeholder=" 资讯名称" style="width:250px" class="input-text">
