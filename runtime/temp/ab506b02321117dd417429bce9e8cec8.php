<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"D:\phpStudy\WWW\APP\public/../application/admin\view\message\message_upd.html";i:1498800461;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
    ...
    <form class="form form-horizontal" id="form-article-add" method="post" action="<?php echo url('message/message_upd'); ?>">
          <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $oldData['name']; ?>" placeholder="" id="articletitle" name="name">
            </div>
        </div>
          <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>电话</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $oldData['phoneNum']; ?>" placeholder="" id="articletitle" name="phoneNum"">
            </div>
        </div>
            <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>留言</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $oldData['message']; ?>" placeholder="" id="articletitle" name="message">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $oldData['reply']; ?>" placeholder="" id="articletitle" name="reply">
            </div>
        </div>
