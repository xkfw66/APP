<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"D:\phpStudy\WWW\APP\public/../application/bis\view\location\add.html";i:1498708104;s:69:"D:\phpStudy\WWW\APP\public/../application/bis\view\public\header.html";i:1484472326;s:69:"D:\phpStudy\WWW\APP\public/../application/bis\view\public\footer.html";i:1497686880;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
...
<article class="page-container">
    <form class="form form-horizontal" id="form-article-add" method="post" action="<?php echo url('Location/add'); ?>">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-3">
                <input type="text" name="open_time" class="input-text" id="countTimestart" onfocus="selecttime(1)" value="" style="width:220px;" >
            </div>
        </div>
