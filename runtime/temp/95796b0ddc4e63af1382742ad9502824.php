<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"D:\phpStudy\WWW\APP\public/../application/admin\view\bis\apply.html";i:1498716555;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
            ...
            <tr class="text-c">
                ...
                <td class="td-manage">
                    <a style="text-decoration:none" class="ml-5"
                       onClick="o2o_edit('商户入驻详情数据','<?php echo url('bis/detail', ['id'=>$vo['id']]); ?>')" href="javascript:;" title="查看">
                    ...
                    <a style="text-decoration:none" class="ml-5"  href="<?php echo url('bis/status',['id'=>$vo['id'], 'status'=>2]); ?>" title="不通过"><i class="Hui-iconfont">不通过</i></a>
                </td>
            </tr>
