<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"D:\phpStudy\WWW\APP\public/../application/bis\view\register\index.html";i:1499130320;s:69:"D:\phpStudy\WWW\APP\public/../application/bis\view\public\header.html";i:1484472326;s:69:"D:\phpStudy\WWW\APP\public/../application/bis\view\public\footer.html";i:1497686880;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
...
<article class="page-container">
	<form class="form form-horizontal"  method="post" action="<?php echo url('register/add'); ?>" enctype="multipart/form-data">
	基本信息：
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-3">
				<input type="text" name="open_time" class="input-text" id="countTimestart" value="" style="width:220px;" >
			</div>
		</div>
