<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"D:\phpStudy\WWW\APP\public/../application/admin\view\bis\index.html";i:1498461140;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="mt-20">
      ...
      <?php if(is_array($bis) || $bis instanceof \think\Collection || $bis instanceof \think\Paginator): $i = 0; $__LIST__ = $bis;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <tr class="text-c">
                ...
                <td class="td-status"><?php echo status($vo['status'] ); ?></a></td>
                <td class="td-manage">
                    ...
                    <a style="text-decoration:none" class="ml-5" onClick="o2o_del('<?php echo url('bis/status', ['id'=>$vo['id'], 'status'=>-1]); ?>')" href="javascript:;" title="删除">
                        ...
                        <a style="text-decoration:none" class="ml-5"  href="<?php echo url('bis/status',['id'=>$vo['id'], 'status'=>2]); ?>" title="不通过"><i class="Hui-iconfont">不通过</i>
                    </a>
                </td>
            </tr>
