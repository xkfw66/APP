<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"D:\phpStudy\WWW\APP\public/../application/admin\view\become\become.html";i:1499054990;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-container">
	<div class="text-c">
	 ...
	 <span class="select-box inline">
        ...
        <input type="text" name="become" id="become" placeholder=" 资讯名称" style="width:250px" class="input-text">
