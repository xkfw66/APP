<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"D:\phpStudy\WWW\APP\public/../application/admin\view\message\message_add.html";i:1498723828;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
    ...
    <form class="form form-horizontal" id="form-article-add" method="post" action="<?php echo url('message/message_add'); ?>">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" -value="" placeholder="" id="articletitle" name="reply">
            </div>
        </div>
