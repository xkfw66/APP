<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"D:\phpStudy\WWW\APP\public/../application/admin\view\location\index.html";i:1498816851;s:71:"D:\phpStudy\WWW\APP\public/../application/admin\view\public\header.html";i:1498183855;s:71:"D:\phpStudy\WWW\APP\public/../application/admin\view\public\footer.html";i:1498183828;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-bg table-hover table-sort">
            ...
            <tr class="text-c">
                ...
                <td><?php echo $vo['id']; ?></td>
                <td class="td-status">
                    <a href=" <?php echo url('Location/status',['id'=>$vo['id'], 'status'=>0]); ?>" title="点击修改状态"><?php echo status($vo['status']); ?></a></td>
