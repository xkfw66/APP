<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"D:\phpStudy\WWW\APP\public/../application/admin\view\deal\apply.html";i:1498808290;s:71:"D:\phpStudy\WWW\APP\public/../application/admin\view\public\header.html";i:1498183855;s:71:"D:\phpStudy\WWW\APP\public/../application/admin\view\public\footer.html";i:1498183828;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-bg table-hover table-sort">
            ...
            <tr class="text-c">
                ...
                <td class="td-status">
                    <a href=" <?php echo url('deal/status',['id'=>$vo['id'], 'status'=>1]); ?>" title="点击修改状态"><?php echo status($vo['status']); ?></a></td>

                <td class="td-manage">
                    <a style="text-decoration:none" class="ml-5"
                       onClick="o2o_edit('商户入驻详情数据','<?php echo url('deal/detail', ['id'=>$vo['id']]); ?>')" href="javascript:;" title="查看">
                        <i class="Hui-iconfont">&#xe6df;</i>
                    </a>
                    <a style="text-decoration:none" class="ml-5" onClick="o2o_del('<?php echo url('deal/status', ['id'=>$vo['id'], 'status'=>-1]); ?>')" href="javascript:;" title="删除">
                        <i class="Hui-iconfont">&#xe6e2;</i>
                    </a>
                    <a style="text-decoration:none" class="ml-5"  href="<?php echo url('deal/status',['id'=>$vo['id'], 'status'=>2]); ?>" title="不通过"><i class="Hui-iconfont">不通过</i></a>
                </td>
