<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"D:\phpStudy\WWW\APP\public/../application/admin\view\login\login.html";i:1496853658;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
	<meta charset="utf-8">
...
<div class="header"><h1>阳光生活馆后台管理系统</h1></div>
		...
		<form class="form form-horizontal" action="" method="post">
			...
			<div class="row cl">
				<div class="formControls col-xs-8 col-xs-offset-3">
					...
					<img src="<?php echo captcha_src(); ?>" alt="captcha" onclick= "this.src=this.src+'?'+Math.random()"/></div>
			</div>
			<div class="row cl">
				<div class="formControls col-xs-8 col-xs-offset-3">
					<label for="online">
