<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"D:\phpStudy\WWW\APP\public/../application/admin\view\message\message.html";i:1499060795;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-container">
	<div class="text-c">
	 ...
	 <span class="select-box inline">
        ...
        <input type="text" name="message" id="message" placeholder=" 资讯名称" style="width:250px" class="input-text">
        <button name="" id="" class="btn btn-success" type="submit"><i class="Hui-iconfont">&#xe665;</i> 搜资讯</button>
    </form>
    </div>
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>
	 <a class="btn btn-primary radius" data-title="添加资讯" data-href="<?php echo url('message/message_add'); ?>" onclick="Hui_admin_tab(this)" href="javascript:;">
		...
		<table class="table table-border table-bordered table-bg table-sort">
			...
			<?php if(is_array($field) || $field instanceof \think\Collection || $field instanceof \think\Paginator): if( count($field)==0 ) : echo "" ;else: foreach($field as $key=>$vo): ?>
				<tr class="text-c">
					...
					<td class="text-l"> <?php echo $vo['phoneNum']; ?></td>
					<td class="text-l"> <?php echo $vo['message']; ?></td>
					<td class="text-l"> <?php echo $vo['reply']; ?></td>
